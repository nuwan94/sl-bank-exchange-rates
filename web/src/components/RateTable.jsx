      ...
      <table className="table-auto border-collapse w-full text-xs sm:text-sm">
        <thead>
          <tr className="bg-slate-100 text-slate-700">
            <th className="text-left px-3 py-3 border-r border-slate-300 font-semibold uppercase tracking-[0.08em]">
              Currency
            </th>
            {bankKeys.map((bank) => (
              <th
                key={bank}
                className="text-right px-3 py-3 border-l border-slate-300 font-semibold uppercase tracking-[0.08em]"
              >
        ...
        <tbody>
          {currencies.map((currency) => {
            ...
            return (
              ...
              >
                <td className="font-semibold px-3 py-3 border-r border-slate-300">
                  {currency.code}
